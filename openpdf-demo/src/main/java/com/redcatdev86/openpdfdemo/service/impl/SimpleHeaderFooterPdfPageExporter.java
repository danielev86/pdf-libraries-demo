...
import com.redcatdev86.openpdfdemo.event.HeaderFooterPageEventHandler;
...
public class SimpleHeaderFooterPdfPageExporter extends AbstractPdfExporterImpl<String>{
    @Override
    protected void populateData(String data, ByteArrayOutputStream out) throws IOException {
        ...
        writer.setPageEvent(new HeaderFooterPageEventHandler());
        document.open();
